...
def check_controls_timeout_alert(sm):
  ...
  if controls_missing > CONTROLS_TIMEOUT:
    if sm['controlsState'].enabled and (controls_missing - CONTROLS_TIMEOUT) < 50:
      return True
...
class Soundd:
  def __init__(self):
    ...
    self.disable_start_stop_sounds = load_bool_param("TinklaDisableStartStopSounds", False)
    self.disable_prompt_sounds = load_bool_param("TinklaDisablePromptSounds",False)
